...
@CheckInfo(name = "BadAim (A)", description = "Checks for a generic flaw in aim assistance tools.", experimental = true)
public class BadAimA extends Check {
    ...
    public BadAimA(final PlayerData data) {
        super(data);
    }
