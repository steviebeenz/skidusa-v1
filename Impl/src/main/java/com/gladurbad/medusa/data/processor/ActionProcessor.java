...
public final class ActionProcessor {
    ...
    private int heldItemSlot, lastHeldItemSlot, lastDiggingTick, lastPlaceTick, lastBreakTick,
            sprintingTicks, sneakingTicks, lastActionTicks, ticksSincePlacing;

    private long lastFlyingTime, ping, lastPlaceTime, lastAnimationTime,
            ticksSinceEntityUse;
    ...
    public void handleBlockDig(final WrappedPacketInBlockDig wrapper) {
        sendingDig = true;
        lastActionTicks = Medusa.INSTANCE.getTickManager().getTicks();
